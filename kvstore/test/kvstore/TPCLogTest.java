...
public class TPCLogTest {
    ...
    public void setupLogAbort(TPCLog log){
    ...
    public void setupLogUneven(TPCLog log){
        KVMessage putGeorge = new KVMessage(KVConstants.PUT_REQ);
        putGeorge.setKey("george");
        putGeorge.setValue("yiu");
        KVMessage putRiyaz = new KVMessage(KVConstants.PUT_REQ);
    ...
    public void checkBuild(){
        ...
        catch (KVException e) {assertTrue(e.getMessage().equals(KVConstants.ERROR_NO_SUCH_KEY));}
        try{
            slave1.get("riyaz");
        }
        catch (KVException e) {assertTrue(e.getMessage().equals(KVConstants.ERROR_NO_SUCH_KEY));}
    ...
    protected void startMockSlaveAbort(long slaveID, int deathOption) throws Exception {
    ...
    protected void startMockSlaveUneven(long slaveID, int deathOption) throws Exception {
        String name = new Long(slaveID).toString();
        ServerRunner sr = slaveRunners.get(name);
        if (sr != null) {
            sr.stop();
